...
<AffiliateBox
  ...
  stars={5}
  price="$37"
  description="TSX templates for Next.js opengraph-image & twitter-image. Get all the code to generate infinite open graph images for your website, blog, or social media posts for a one-time payment."
