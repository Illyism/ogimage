              ...
              <FadeIn className="sm:mt-16">
                ...
                <div className="relative mx-auto rounded-xl border border-foreground/5 bg-foreground/5 p-1.5 sm:-rotate-1">
                  ...
                  >
                    <meta
                      itemProp="name"
                      content={`MagicSpace review by ${bankG.endorser.name}, ${bankG.endorser.tagline}`}
                    />
                    <meta
                      itemProp="thumbnailUrl"
                      content={bankG.video_poster ?? bankG.endorser.avatar}
                    />
                    <meta itemProp="uploadDate" content={bankG.date} />
                    <meta itemProp="contentUrl" content={bankG.video_mp4_url} />
                    <span itemProp="description">{bankG?.text}</span>
                  </video>
                </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative mt-[-2rem] space-y-5 md:mt-0 lg:mt-16 xl:mt-24">
              ...
              <p className="lg:text-lg">
                ...
                under six months. It is currently the top result for green
                banking and related keywords.
              </p>
