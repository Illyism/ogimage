    ...
    <Container className="mb-8 mt-16 lg:mb-16 lg:mt-32">
      <div className="mx-auto text-center">
        ...
        <h2 className="text-xl font-bold tracking-tight sm:mb-6 md:text-4xl">
          Customers rave about our exceptional SEO services!
        </h2>
        <div className="mb-6 font-bold md:text-xl lg:mb-12">
          Let&apos;s hear directly from our SEO clients.
        </div>
      </div>
      <BankGreenSection />
    </Container>
    ...
    <div className="mx-auto max-w-4xl">
      <div className="flex flex-col items-start justify-center gap-10 lg:flex-row lg:gap-20">
        <div className="relative w-full lg:w-1/2">
          <Image
            className="pointer-events-none absolute -top-48 hidden h-full w-full select-none object-contain opacity-75 dark:opacity-100 sm:inset-0 sm:block sm:scale-[2]"
