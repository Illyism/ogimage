...
export const Faq = () => (
  <div className="container pt-16 pb-24 sm:text-center">
    ...
    <div className="mx-auto mt-12 max-w-3xl space-y-6">
      ...
      />
      <FAQCard
        answer="You get free access to the source code of OG Image Generator. You can host it on your own server. We have examples for Vercel, Firebase, Docker, and more. If there is something you need, we are here to help."
      ...
      />
      <FAQCard
        answer="Leave your email on this page. We send the Notion guide and invite you to the GitHub repository. There is no payment."
        question="How do I get access?"
      />
      <FAQCard
        answer="Yes. OG Image Kit is free. Leave your email to get the source code, templates, and guide."
        question="Is it free?"
      />
      <FAQCard
